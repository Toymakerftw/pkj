...
<?php include 'navbar.php'; ?>
    <div class="flex justify-center items-center h-screen">
        <div class="container mx-auto bg-white p-8 rounded-lg shadow-lg w-96">
            <h1 class="text-2xl text-center mb-4">Welcome, Team Leader!</h1>
            <p class="text-center">This is the dashboard for team leaders. You can manage your team and tasks here.</p>
